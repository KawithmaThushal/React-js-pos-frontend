    ...
    return(
        ...
        <div className="flex-1 flex flex-col bg-cyan-50">
          ...
          <div className="flex justify-between items-center bg-white py-4 px-6 ">
            <h2 className="text-xl font-semibold font-serif">📍Employee/View</h2>
      ...
      <table className="w-[1150px] font-serif text-left text-gray-500 m-4">
        <thead className="text-xs text-gray-700 uppercase bg-pink-50 font-serif">
          <tr>
            <th scope="col" className="px-6 py-3">Employee ID</th>
            <th scope="col" className="px-6 py-3">Employee Name</th>
            <th scope="col" className="px-6 py-3">Add Date</th>
            <th scope="col" className="px-6 py-3">Action</th>
          </tr>
        </thead>
        <tbody>
      {EmplDeatils.map(function (details){
        return(
          <tr  className="bg-white border-b hover:bg-gray-50">


          <td className="px-6 py-4">{details.fname+details.lname}</td>
          <td className="px-6 py-4">{details.id}</td>
          <td className="px-6 py-4">{details.city}</td>
          <td className="px-6 py-4"> <button className="text-white bg-blue-500 hover:bg-blue-600 px-3 py-1 rounded-lg text-sm focus:ring-2 focus:ring-blue-300"
                 >
                    Edit
                  </button>
